...
import com.deogicorgi.core.model.MemberDto;
...
public class MemberController {
    ...
    @PatchMapping
    public Mono<ApiResponse> modify(@RequestBody MemberDto member) {
        return null;
    }

    @PutMapping
    public Mono<ApiResponse> update(@RequestBody MemberDto member) {
        return null;
    }
